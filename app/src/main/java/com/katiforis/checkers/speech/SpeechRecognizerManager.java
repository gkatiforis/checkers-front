package com.katiforis.checkers.speech;
...
public class SpeechRecognizerManager {
    ...
    public SpeechRecognizerManager(Context context,onResultsReady listener)
    {
        ...
        mSpeechRecognizerIntent.putExtra(RecognizerIntent.EXTRA_SPEECH_INPUT_MINIMUM_LENGTH_MILLIS,  new Long(5000));

        mSpeechRecognizerIntent.putExtra(RecognizerIntent.EXTRA_LANGUAGE, "el-GR");
